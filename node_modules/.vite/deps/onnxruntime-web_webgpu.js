...
async function es(a = {}) {
  ...
  var gr = (e) => {
    ...
    for (var u of e) {
      if (u === 0 || u === o) break;
      if (Do(u, o, n.Qc + 16)) return St(u), t;
    }
    return St(o), t;
  };
  function js() {
    ...
    if (g === "gpu-buffer") {
      ...
      if (Array.isArray(U)) {
        ...
        if (w !== "string" && M && Y) {
          ...
          } else C = U.byteLength, S = m._malloc(C), s.push(S), m.HEAPU8.set(new Uint8Array(U.buffer, U.byteOffset, C), S);
        } else C = U.byteLength, S = m._malloc(C), s.push(S), m.HEAPU8.set(new Uint8Array(U.buffer, U.byteOffset, C), S);
      }
    }
...
export {
  qf as InferenceSession,
  Ga as TRACE,
  $e as TRACE_EVENT_BEGIN,
  ze as TRACE_EVENT_END,
  tt as TRACE_FUNC_BEGIN,
  rt as TRACE_FUNC_END,
  Le as Tensor,
  gl as default,
  K as env,
  Ke as registerBackend
};
