...
- Name: 10-regression.spec.js >> Visual regression >> keeps the hero compact and punchy
- Location: tests\e2e\10-regression.spec.js:12:3
...
Locator: locator('header.hero')
Timeout: 5000ms
  Timeout 5000ms exceeded.

  Snapshot: hero-compact.png

Call log:
  - Expect "toHaveScreenshot(hero-compact.png)" with timeout 5000ms
    - verifying given screenshot expectation
  - waiting for locator('header.hero')
    - locator resolved to <header class="hero card">…</header>
